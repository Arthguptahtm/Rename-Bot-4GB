...
API_ID = int(os.environ.get("API_ID", "21134510"))
API_HASH = os.environ.get("API_HASH", "a9ccc3862be61cab5841afcf1184ef18")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "")
ADMIN = int(os.environ.get("ADMIN", "2104240939"))
...
FORCE_SUBS = os.environ.get("FORCE_SUBS", "-1001799535143")
LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002608520327"))


# Mongo DB Database Config
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://neetugupta183:33HIOXHsgMuKgGUx@cluster0.hzumh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
